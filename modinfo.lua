...
name = "Kochosei in Onmyoji 23/01/2024"
description = [[
...
local function Title(title)
    return { name = title, hover = "", options = { { description = "", data = 0 } }, default = 0 }
end
...
for i = 1, 10, 1 do
    option_kocho[#option_kocho + 1] = { description = string.format("%d", i), data = i }
end

for i = 10, 100, 10 do
    optionsbasic_weapon[#optionsbasic_weapon + 1] = { description = string.format("%d", i), data = i }
end
...
for i = 50, 1000, 50 do
    optionsbasic_weapon_dub[#optionsbasic_weapon_dub + 1] = { description = string.format("%d", i), data = i }
end
optionsbasic_weapon_dub[#optionsbasic_weapon_dub + 1] = { description = "Infinite", data = "Infinite" }


for i = 50, 1000, 50 do
    optionslave_basic_damage[#optionslave_basic_damage + 1] = { description = string.format("%d", i), data = i }
    optionsbasic[#optionsbasic + 1] = { description = string.format("%d", i), data = i }
end
...
configuration_options = {
    {
        ...
        options = { { description = "No", data = 0 }, { description = "Yes", data = 1 } },
        default = 1,
    },
    {
        name = "kocho_wick",
...

    {
        ...
        options = { { description = "OFF", data = 0 }, { description = "ON", data = 1 } },
        default = 1,
    },
