local function make(code, description, check_des_boolean, alter_description, fileanim)
	...
	STRINGS.CHARACTERS.GENERIC.DESCRIBE[string.upper(code)] = alter_description or STRINGS.SKIN_DESCRIPTIONS[code] or ((description or STRINGS.NAMES[string.upper(code)] or STRINGS.SKIN_NAMES[string.lower(code)] or '???')..'。')
...
return
    make("kochosei_card_defend", "Thẻ Phòng Thủ", nil, "Giới hạn damage nhận vào còn 10% máu", nil),
