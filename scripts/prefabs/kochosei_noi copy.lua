...
local function SetProductSymbol(inst, product, overridebuild)
    ...
    print("SetProductSymbol", product, potlevel, build, overridesymbol)
...
local function cookpot_common(inst)
    ...
    inst.AnimState:SetBuild("kocho_portable_cook_pot")
    inst.AnimState:PlayAnimation("idle_empty")
...
local function MakeCookPot(name, common_postinit, master_postinit, assets, prefabs)
    local function fn()
        ...
        inst.Light:SetColour(102/255,255/255,255/255)
...
return MakeCookPot("kochosei_cookpot", cookpot_common, cookpot_common_master, assets, prefabs),
    MakePlacer("kochosei_cookpot_placer", "cook_pot", "cook_pot", "idle_empty")