    ...
    if not inst.components.fueled:IsEmpty() then
        ...
        inst._light.entity:SetParent((owner or inst).entity)
            ...
            if inst.components.equippable:IsEquipped() then
                inst.components.inventoryitem.owner.AnimState:OverrideSymbol("swap_object", "swap_kochosei_lantern", "swap_lantern_on")
...
local function turnoff(inst)
    ...
    if inst.components.equippable:IsEquipped() then
        inst.components.inventoryitem.owner.AnimState:OverrideSymbol("swap_object", "swap_kochosei_lantern", "swap_lantern_off")
...
return Prefab( "common/inventory/kochosei_lantern", fn, assets),
Prefab("kochoseilanternlight", lanternlightfn)
