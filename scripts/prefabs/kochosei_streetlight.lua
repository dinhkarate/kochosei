local assets = {Asset("ANIM", "anim/kochosei_streetlight1_left.zip"),
...
return Prefab("kochosei_streetlight1_left", left, assets),
    MakePlacer("kochosei_streetlight1_left_placer", "kochosei_streetlight1_left", "kochosei_streetlight1_left",
        "idle_on", nil, nil, nil, SCALE), Prefab("kochosei_streetlight1_right", right, assets),
    MakePlacer("kochosei_streetlight1_right_placer", "kochosei_streetlight1_right", "kochosei_streetlight1_right",
        "idle_on", nil, nil, nil, SCALE)
