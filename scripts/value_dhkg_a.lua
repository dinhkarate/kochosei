...
TUNING.KOCHOSEI_VANILLA_MODE = GetModConfigData("kochosei_va_waifu")
...
TUNING.KOCHOSEI_ARMOR = GetModConfigData("kocho_armor_fix")
...
--Sword
TUNING.KOCHO_SWORD_DAMAGE = GetModConfigData("kocho_sword_damage")
TUNING.KOCHO_SWORD_DURABILITY = GetModConfigData("kocho_sword_dub")
--Kocho Hat 1
...
TUNING.KOCHOSEI_DUKE_DAMAGE = 400
TUNING.KOCHOSEI_DUKE_ATTACK_PERIOD = 3
TUNING.KOCHOSEI_DUKE_ATTACK_RANGE = 4
TUNING.KOCHOSEI_DUKE_SPLASH_RADIUS = 5
TUNING.KOCHOSEI_DUKE_SPLASH_DAMAGE = 125
